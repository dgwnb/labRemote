...
#include "../WaferProberGUI/src/CameraThread.h"
...
QT_MOC_LITERAL(3, 23, 6) // "doWork"
    ...
    "CameraTask\0imageReady\0\0doWork"
};
...
void CameraTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CameraTask *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CameraTask::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraTask::imageReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CameraTask::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_CameraTask.data,
    qt_meta_data_CameraTask,
    qt_static_metacall,
    nullptr,
    nullptr
} };
